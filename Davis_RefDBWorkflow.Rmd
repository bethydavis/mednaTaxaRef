...
counts_species <- as.data.frame(table(dedup_REFDB$species)) #count the number of unique reference sequences per species
...
```{r save_dedup}
write.csv(dedup_REFDB, file.path(path_outputs, "COI_REFDB_dedup.csv"), row.names=FALSE)
```
