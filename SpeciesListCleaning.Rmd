...
# Loading in the saved object from 3/8 created after joining the meta species list and GBIF list
...
# Convert the SourceList column from lists to character strings, and remove the 'c'
